...
\title{OER Example Textbook}
\newcommand{\subtitle}{Learning to Use Lantern.}
\newcommand{\booklicense}{\href{https://creativecommons.org/licenses/by/4.0/}{Attribution
4.0 International (CC BY 4.0)}}

% authors %
\author{Sammy Spartan \and Frankie Faculty}
...
% Title
\textbf{\fontsize{48}{54}\selectfont OER Example Textbook \\}
\textbf{\large \textit{Learning to Use Lantern.}}
...
\begin{flushright}
      ...
      \textbf{Sammy Spartan}, \emph{Aurora University}\\
      \textbf{Frankie Faculty}, \emph{Aurora University}\\
...
Place of publication: Publisher, Year of publication.{]}
  ...
  \item[Date] \hfill \\ 2021
    \item[Website] \hfill \\ www.aurora.edu
  ...
  \item[keywords] \hfill \\ OER, keyword, keyword
    \item[Contributors] \hfill \\ Lisa Librarian, Research Assistant
